...
import { NavLink, NavSectionTitle, RobinNavItemsType } from 'src/@core/layouts/types'
...
const RobinNavItems = (props: Props) => {
  ...
  const RenderMenuItems = robinNavItems?.map((item: NavLink | NavSectionTitle, index: number) => {
